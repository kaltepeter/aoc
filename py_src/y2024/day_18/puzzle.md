...
You can take steps up, down, left, or right. After just 12 bytes have corrupted locations in your memory space, the shortest path from the top left corner to the exit would take `__22__` steps. Here (marked with `O`) is one such path:

```text
__O____O__.#__O____O____O__
.__O__#__O____O__#__O__
.__O____O____O__#__O____O__
...#__O____O__#
..#__O____O__#.
.#.__O__#..
#.#__O____O____O____O__
```
