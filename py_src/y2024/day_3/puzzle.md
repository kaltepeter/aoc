...
```text
x__mul(2,4)__%&mul[3,7]!@^do_not___mul(5,5)__+mul(32,64]then(__mul(11,8)mul(8,5)__)
```

Only the four highlighted sections are real `mul` instructions. Adding up the result of each instruction produces `__161__` (`2*4 + 5*5 + 11*8 + 8*5`).
